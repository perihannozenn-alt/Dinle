...
const s = StyleSheet.create({
  ...
  collectionCard: { minHeight: 128, flexDirection: 'row', alignItems: 'center', gap: 14, backgroundColor: C.surface, borderRadius: 14, padding: 14, borderWidth: 1.5, borderColor: C.primary + '66' },
  collectionArt: { width: 92, height: 92, borderRadius: 12, alignItems: 'center', justifyContent: 'center', backgroundColor: C.primary + '18', overflow: 'hidden' },
  collectionImage: { width: 92, height: 92 },
